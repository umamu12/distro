    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo $url ?>">Online Distro</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo $url ?>">Home</a></li>
            <li><a href="<?php echo $url ?>product.php">Product</a></li> 
            <li><a href="<?php echo $url ?>contact.php">Contact us</a></li> 
            <li><a href="<?php echo $url ?>info.php">Payment info </a></li> 
            <?php if(!empty($_SESSION['iam_user'])){ ?>
			<?php 
				$user = mysqli_fetch_object(mysqli_query($connect, "SELECT*FROM user where id='$_SESSION[iam_user]'"));
			?>
      <li><a href="<?php echo $url ?>payment.php">Payment</a></li>      
			<li class="dropdown">
